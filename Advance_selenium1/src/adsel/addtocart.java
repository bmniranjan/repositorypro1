...
public class addtocart
{
	...
	Thread.sleep(5000);
	d.findElement(By.xpath("//div[@class='center-2']/div[2]/div[2]/div[3]/div[3]/div/div[2]/div[3]/div[2]")).click();
	Thread.sleep(3000);
	d.findElement(By.xpath("//span[text()='Shopping cart']")).click();
	Thread.sleep(3000);
	d.findElement(By.xpath("//span[text()='Shopping cart']")).click();
	Thread.sleep(3000);
	d.findElement(By.xpath("//table[@class='cart']/tbody/tr[2]/td[1]/input[1]")).click();
	Thread.sleep(3000);
